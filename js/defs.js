...
var FilesBrd = new Array(BOARD_NUMBER);
var RanksBrd = new Array(BOARD_NUMBER);
...
var Sq120ToSq64 = new Array(BOARD_NUMBER);
...
function HASH_PCE(pce, sq) {
	Desk.posKey ^= PieceKeys[(pce * 120) + sq];
}

function HASH_CA() { Desk.posKey ^= CastleKeys[Desk.castlePerm]; }
function HASH_SIDE() { Desk.posKey ^= SideKey; }
function HASH_EP() { Desk.posKey ^= PieceKeys[Desk.enPas]; }
